...
const MonteCarloPage: React.FC = () => {
  ...
  const handleRunSimulation = async () => {
    ...
    if (!isEligibleForMonteCarlo(selectedStrategy.strategy_type)) {
      setError('The selected strategy is not eligible for Monte Carlo simulation. Only SMA Crossover, DCA, and Buy & Hold Advanced strategies are supported.');
      return;
    }
  ...
  const isEligibleForMonteCarlo = (strategyType: string): boolean => {
    return ['simple_moving_average_crossover', 'dca', 'buy_hold_markers'].includes(strategyType);
  };
            ...
            {result && (
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
                  ...
                  <div className="p-4 bg-gray-50 rounded-lg">
                    <div className="text-sm text-gray-600">Mean Final Capital</div>
                ...
                <div className="mb-6">
                  <h3 className="text-lg font-semibold mb-3">Percentiles (Final Capital)</h3>
                ...
                <div className="mb-6">
                  <h3 className="text-lg font-semibold mb-3">Percentiles (Return %)</h3>
                  <div className="grid grid-cols-5 gap-4">
