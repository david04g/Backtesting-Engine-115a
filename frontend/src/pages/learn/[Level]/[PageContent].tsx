...
//     if (isLastLesson && baseCanAdvance && !levelUpComplete) {
...
//         message="Congratulations on completing this level! You've unlocked new content."
...
const PageContent = () => {
  ...
  // Derived UI state (these must be computed before the level-up effect so the effect can read them unconditionally)
  ...
  // ********** MOVED LEVEL-COMPLETION EFFECT HERE (BEFORE any early returns) **********
  useEffect(() => {
  ...
  // UI values (recompute now that we know lessonData exists)
