...
const Card: React.FC<{
  ...
  bg?: string;
  className?: string;
}> = ({ title, children, bg = "#D9F2A6", className }) => (
  <div
    className={`rounded-md p-6 border border-black/10 ${className || ""}`}
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="px-12 py-8 grid grid-cols-12 gap-8 flex-1 items-start">
          ...
          <div className="col-span-4">
            <Card>
              <div className="text-xs font-bold uppercase text-center mb-3">
                Current Level
              </div>
              <div
                className="mx-auto rounded-md p-8 text-center"
                style={{ backgroundColor: "#F0B3BD" }}
              >
                <div
